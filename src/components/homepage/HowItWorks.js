  ...
  const steps = [
    {
      ...
      description: "Enter the nonprofit's name, website, or describe the mission in plain language. Engrant's AI researches the organization automatically — no lengthy intake forms."
    },
    {
      icon: Target,
      step: '02',
      title: 'Get pre-evaluated grants in minutes',
      description: "Engrant's AI searches across the web for grant opportunities matching the mission, geography, and capacity — then evaluates each one for fit, eligibility, competition, and effort. Not just keywords. Real analysis."
    },
    {
      icon: Brain,
      step: '03',
    ...
    },
    {
      icon: Rocket,
      step: '04',
      title: 'See the full picture before you apply',
      description: "Each grant comes with eligibility in plain English, estimated effort level, deadline, fit analysis — and critical considerations like payment schedules, competition levels, and potential red flags. The evaluation you'd do manually, already done."
    }
  ];
