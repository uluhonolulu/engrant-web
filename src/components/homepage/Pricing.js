        ...
        <div id="pricing-cards" className="max-w-lg mx-auto">
          <div className="relative">
            ...
            <div className="relative bg-white rounded-3xl p-10 border border-teal-100 warm-shadow-lg">
              <h3 className="text-sm font-bold text-teal-600 tracking-wider mb-3">GRANT RESEARCH PRO</h3>
              ...
              <div className="space-y-4 mb-10">
                ...
                <div className="flex items-center">
                  ...
                  <span className="text-neutral-600">Unlimited organizations</span>
                </div>
                <div className="flex items-center">
                  <div className="w-6 h-6 rounded-full bg-teal-100 flex items-center justify-center mr-4 flex-shrink-0">
                    <Check className="text-teal-600 w-4 h-4" />
                  </div>
                  <span className="text-neutral-600">30–50 pre-evaluated grants per search</span>
                </div>
                <div className="flex items-center">
                  <div className="w-6 h-6 rounded-full bg-teal-100 flex items-center justify-center mr-4 flex-shrink-0">
                    <Check className="text-teal-600 w-4 h-4" />
                  </div>
                  <span className="text-neutral-600">Fit analysis, red flags, and strategic considerations per grant</span>
                </div>
                <div className="flex items-center">
                  <div className="w-6 h-6 rounded-full bg-teal-100 flex items-center justify-center mr-4 flex-shrink-0">
                    <Check className="text-teal-600 w-4 h-4" />
