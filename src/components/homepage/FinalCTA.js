    ...
    <section id="final-cta" className="py-28 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative">
        <h2 className="text-4xl lg:text-6xl font-bold mb-8 text-white leading-tight">
          Find the funders you don&apos;t know about yet
        </h2>

        <p className="text-xl lg:text-2xl mb-12 text-teal-100 max-w-2xl mx-auto leading-relaxed">
          Enter the organization. Get funders that aren&apos;t in any database, each one already evaluated for fit, eligibility, and red flags.
        </p>

        <a
          href="https://app.engrant.eu/?utm_source=landing&utm_medium=cta&utm_campaign=final_cta"
          onClick={() => {
