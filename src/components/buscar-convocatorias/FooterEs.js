...
import { ONE_LINE_DEFINITION } from '../../constants/positioningEs';

const FooterEs = ({ tagline = ONE_LINE_DEFINITION }) => {
  return (
    <footer className="bg-slate-900 text-slate-400 py-12">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col lg:flex-row justify-between gap-8">
          <div>
            <a href="/buscar-convocatorias/" className="text-white font-bold text-xl">Engrant</a>
