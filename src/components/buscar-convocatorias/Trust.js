        ...
        <div id="trust-stats" className="grid md:grid-cols-3 gap-8">
          <div className="group relative">
            ...
            <div className="relative bg-white rounded-2xl p-8 text-center border border-teal-100 warm-shadow">
              ...
              <div className="text-2xl font-bold text-teal-600 mb-2">Coincidencias seleccionadas</div>
              <div className="text-neutral-500">No más de 300 resultados irrelevantes</div>
            </div>
          </div>
          ...
          <div className="group relative">
            ...
            <div className="relative bg-white rounded-2xl p-8 text-center border border-amber-100 warm-shadow">
              ...
              <div className="text-neutral-500">Tiempo promedio hasta los resultados</div>
            </div>
          </div>
          ...
          <div className="group relative">
            ...
            <div className="relative bg-white rounded-2xl p-8 text-center border border-teal-100 warm-shadow">
              ...
              <div className="text-4xl font-bold text-teal-600 mb-2">$47 USD/mes</div>
              <div className="text-neutral-500">Menos de una hora de consultor</div>
            </div>
          </div>
        </div>
      </div>
