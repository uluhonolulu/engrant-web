      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            <a 
              href="https://app.engrant.eu/?utm_source=instrumentl_comparison&utm_medium=cta&utm_campaign=header_cta"
              onClick={() => {
    ...
    <section className="hero-gradient min-h-[600px] flex items-center py-20 relative overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative text-center">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-8">
          <a 
            href="https://app.engrant.eu/?utm_source=instrumentl_comparison&utm_medium=cta&utm_campaign=hero_cta"
            onClick={() => {
              if (typeof window !== 'undefined' && window.gtag) {
                window.gtag('event', 'cta_click', {
                  location: 'hero',
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="text-center mb-16">
          ...
          <p className="text-neutral-500 max-w-3xl mx-auto italic">
            Instrumentl is excellent within its database coverage — comprehensive workflow management for larger organizations. The structural difference: Engrant searches the live web; Instrumentl can only show you funders in their database.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className="bg-gradient-to-br from-teal-50 to-teal-100/50 rounded-3xl p-8 border border-teal-100">
            ...
            <p className="text-teal-700 font-medium mt-6 italic">
              Engrant is purpose-built for the 90% of nonprofits that can't justify $299-999/month.
            </p>
          </div>
        </div>
      </div>
            ...
            <div className="relative bg-white rounded-3xl p-8 border border-teal-100 warm-shadow-lg h-full">
              ...
              <div className="mb-6">
                ...
                <p className="text-teal-600 font-medium mt-2">
                  Or ${PRICE_ANNUAL_PER_MONTH}/month when billed annually (${PRICE_ANNUAL_TOTAL}/year)
                </p>
              </div>
              ...
              <a 
                href="https://app.engrant.eu/?utm_source=instrumentl_comparison&utm_medium=pricing&utm_campaign=pricing_cta"
                onClick={() => {
                  if (typeof window !== 'undefined' && window.gtag) {
                    window.gtag('event', 'cta_click', {
                      location: 'pricing',
  ...
  return (
    <section className="py-28 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-8">
          <a 
            href="https://app.engrant.eu/?utm_source=instrumentl_comparison&utm_medium=cta&utm_campaign=final_cta"
            onClick={() => {
              if (typeof window !== 'undefined' && window.gtag) {
                window.gtag('event', 'cta_click', {
                  location: 'final_cta',
