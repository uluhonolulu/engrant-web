...
const ComparisonTable = () => {
  const features = [
    ...
    { category: "Search & Results", feature: "Fit assessment", engrant: "✅ AI-generated fit score with detailed reasons", instrumentl: "⚠️ Match indicators, requires manual review", engrantCheck: true, instrumentlCheck: "partial" },
    { category: "Search & Results", feature: "Eligibility screening", engrant: "✅ Flags disqualifiers before you apply", instrumentl: "⚠️ Sometimes shows ineligible opportunities", engrantCheck: true, instrumentlCheck: "partial" },
    ...
    { category: "Intelligence & Insights", feature: "Red flags & warnings", engrant: "✅ Proactive warnings (consortium required, etc.)", instrumentl: "⚠️ Requirements listed but not flagged", engrantCheck: true, instrumentlCheck: "partial" },
    ...
    { category: "Grant Management", feature: "Team collaboration", engrant: "⚠️ Basic (coming soon)", instrumentl: "✅ Full team features with roles", engrantCheck: "partial", instrumentlCheck: true },
    ...
    { category: "Learning & Improvement", feature: "Learns from feedback", engrant: "✅ Improves based on saves/rejects", instrumentl: "⚠️ Improves match relevance", engrantCheck: true, instrumentlCheck: "partial" },
